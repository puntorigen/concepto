      ...
      return _asyncToGenerator(function* () {
        ...
        if (commands_.length == 0) {
          ...
          try {
            ...
            resp.error = true;
            resp.valid = false;
            resp.catch = test_err; // @TODO we should throw an error, so our parents catch it (9-AGO-20)
          }
        } else {
          ...
          for (var qm_index in commands_) {
            ...
            try {
              ...
              resp.error = true;
              resp.valid = false;
              resp.catch = test_err; // @TODO we should throw an error, so our parents catch it (9-AGO-20) and break the loop
            }
          }
        }
