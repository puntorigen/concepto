    ...
    */
    ...
    generateAutocompleteFiles() {
      ...
      return _asyncToGenerator(function* () {
        ...
        var meta = _this2.x_commands.meta;
        delete meta.hint;
        ...
        */
        ...
        var attributesToHTMLTable = function attributesToHTMLTable() {
          ...
          var html = "<table width='400' border=1 cellspacing=".concat(theme.cellspacing, " cellpadding=").concat(theme.cellpadding, " bordercolor='").concat(theme.table_bgcolor, "'>"); //table header
          ...
          for (var key in attributes) {
            ...
            html += "<td>".concat(key, "</td>\n<td>").concat(attributes[key].type ? attributes[key].type : '', "</td>\n<td>").concat(attributes[key].default ? attributes[key].default : '', "</td>\n<td>").concat(hint, "</td>\n");
            html += "</tr>\n";
          }
        ...
        for (var hash_ in _this2.autocomplete.records) {
          ...
          for (var file_ of files) {
            ...
            if (file_ != undefined) {
              ...
              var exists = yield _this2.exists(file);
              ...
              if (exists == true) {
                ...
                try {
                  ...
                  var justpath_ = path.dirname(file) + path.sep;
