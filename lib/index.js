(function (global, factory) {
	...
	var require$$0$26 = ( getOwnPropertyDescriptor$1 && getOwnPropertyDescriptor ) || getOwnPropertyDescriptor$1;
	...
	var $Object$3 = require$$1$1.Object;
	var getOwnPropertyNames = function getOwnPropertyNames(it) {
	...
	var require$$0$27 = ( getOwnPropertyNames$1 && getOwnPropertyNames ) || getOwnPropertyNames$1;
	...
	var concepto = function () {
	  ...
	  console.log('x_on_methods says',this.x_on_methods);*/
		...
		_createClass(concepto, [{
			...
			key: 'findCommand',
			value: function () {
				var _ref13 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee12(node, justone) {
					var resp, keys, command_defaults, command_features, def_matched;
	        	...
	        	x_level:''
									...
									command_defaults = setObjectKeys(keys, '');

									console.log('command_defaults', command_defaults);
									command_features = node_features = command_defaults;
									def_matched = setObjectKeys(keys, true);
				...
				function findCommand(_x11, _x12) {
