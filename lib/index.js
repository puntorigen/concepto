        ...
        */
        ...
        var generateKeywordXML = /*#__PURE__*/function () {
          var _ref3 = _asyncToGenerator(function* (record) {
            ...
            if (record.extends_ && record.extends_ != '' && _this3.autocomplete.texts[record.extends_]) {
              ...
              var parentAttribs = Object.keys(_this3.autocomplete.texts[record.extends_].attributes);
              ...
              var parentEvents = Object.keys(_this3.autocomplete.texts[record.extends_].events);
    ...
    addAutocompleteDefinition() {
      ...
      return _asyncToGenerator(function* () {
        ...
        */
        ...
        _this4.autocomplete.texts[text] = {
          text,
          icons,
          level,
          hint,
