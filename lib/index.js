(function (global, factory) {
	...
	var require$$0$29 = ( from$1 && from ) || from$1;
	...
	var require$$0$31 = ( keys$1 && keys ) || keys$1;
	...
	**/
		...
		_createClass(concepto, [{
			...
			value: function () {
				var _ref13 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee12() {
					...
					var resp, keys, command_requires, def_matched, comm, key, comm_keys, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, qi, com_reqs, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, test, testpath, _iteratorNormalCompletion4, _didIteratorError4, _iteratorError4, _iterator4, _step4, word, _iteratorNormalCompletion5, _didIteratorError5, _iteratorError5, _iterator5, _step5, _key, _testpath;

					return regenerator.wrap(function _callee12$(_context12) {
						while (1) {
							switch (_context12.prev = _context12.next) {
								case 0:
									resp = { name: 'not_found', hint: 'failover command' };
									keys = 'x_icons,x_not_icons,x_not_empty,x_not_text_contains,x_empty,x_text_starts,x_text_contains,x_all_hasparent,x_or_hasparent,x_or_isparent,x_level';
								...
								case 67:
									_context12.prev = 67;
									_context12.t3 = _context12['catch'](50);
								...
								case 87:
									...
									return _context12.abrupt('break', 95);
								...
								case 97:
									_context12.prev = 97;
									_context12.t4 = _context12['catch'](85);
								...
								case 109:
									...
									// test 5: x_empty (node keys that must be empty)
								...
								case 117:
									...
									return _context12.abrupt('break', 136);
								...
								case 138:
									_context12.prev = 138;
									_context12.t5 = _context12['catch'](115);
								...
								case 148:
									return _context12.finish(145);

								case 149:
									return _context12.finish(142);
	        ...
	        for (let kkey in list) {
	        	if (comm_keys.indexOf(list[kkey])!=-1) command_features[list[kkey]] = this.x_commands[key][list[kkey]];
					...
					}, _callee12, this, [[16, 28, 32, 40], [33,, 35, 39], [50, 67, 71, 79], [72,, 74, 78], [85, 97, 101, 109], [102,, 104, 108], [115, 138, 142, 150], [143,, 145, 149]]);
				}));
	...
	function allTrue(object, keys) {
		...
		try {
			for (var _iterator6 = _getIterator(keys.split(',')), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
