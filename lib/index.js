    ...
    */
    ...
    cacheCommands() {
      ...
      return _asyncToGenerator(function* () {
        ...
        var x_version = '';
        if (_this4.x_commands.meta && _this4.x_commands.meta.version) x_version = _this4.x_commands.meta.version;
        var x_cmds_hashes = {};
        ...
        _this4.x_console.outT({
          prefix: 'cache,brightYellow',
          message: "x_commands ".concat(x_version),
          color: 'white'
        });
