        ...
        */
        ...
        var generateKeywordXML = /*#__PURE__*/function () {
          var _ref3 = _asyncToGenerator(function* (record) {
            ...
            if (record.parent && record.parent != '' && _this3.autocomplete.records[record.parent]) {
              var merge = require('deepmerge');

              record = merge(_this3.autocomplete.records[record.parent], record); // determine which 'attributes' are from the parent record (inherited)

              var parentAttribs = Object.keys(_this3.autocomplete.records[record.parent].attributes);
              ...
              var parentEvents = Object.keys(_this3.autocomplete.records[record.parent].events);
