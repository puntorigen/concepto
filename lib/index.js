(function (global, factory) {
	...
	var require$$0$11 = ( defineProperty$1 && defineProperty ) || defineProperty$1;
	...
	require$$0$15('getPrototypeOf', function () {
	...
	require$$0$15('getOwnPropertyDescriptor', function () {
	...
	// 19.1.2.7 Object.getOwnPropertyNames(O)
	require$$0$15('getOwnPropertyNames', function () {
	  return gOPNExt.f;
	});
	...
	*/
						...
						while (1) {
							switch (_context.prev = _context.next) {
								...
								case 13:
									...
									_context.next = 16;
									return this.dsl_parser.getNodes({ level: '2', nodes_raw: true });
	...
	var vue = function (_concepto) {
					...
					return regenerator.wrap(function _callee$(_context) {
						while (1) {
							switch (_context.prev = _context.next) {
								...
								case 22:
									_context.next = 24;
									return this._appFolders((_appFolders2 = {
										'client': 'client/',
									...
									}, _defineProperty$1(_appFolders2, 'store', 'client/store/'), _defineProperty$1(_appFolders2, 'lang', 'client/lang/'), _appFolders2));
	  ...
	  */
			...
			key: '_appFolders',
			value: function () {
				var _ref10 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee10(keys) {
						...
						while (1) {
							switch (_context10.prev = _context10.next) {
								case 0:
									...
									_context10.t0 = regenerator.keys(keys);
	  ...
	  */
			...
			value: function () {
				var _ref11 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee11() {
					var resp, path, assets, sep, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, child, key, _loop, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, i18n_node;
						...
						while (1) {
							switch (_context11.prev = _context11.next) {
								...
								case 5:
									...
									_iteratorError = undefined;
									_context11.prev = 12;
									_iterator = _getIterator(assets.nodes);
								...
								case 20:
									...
									_loop = function _loop(i18n_node) {
									...
									_iteratorError2 = undefined;
									_context11.prev = 27;
									for (_iterator2 = _getIterator(child.nodes); !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
										i18n_node = _step2.value;
	  ...
	  */
			...
			value: function () {
				var _ref13 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee13() {
					var resp, config_node, search, _iteratorNormalCompletion3, _didIteratorError3, _iteratorError3, _iterator3, _step3, key, _iteratorNormalCompletion4, _didIteratorError4, _iteratorError4, _iterator4, _step4, meta_child, path, dsl_folder, parent_folder, folder;
						...
						while (1) {
							switch (_context13.prev = _context13.next) {
								...
								case 4:
									...
									_context13.prev = 12;
									_iterator3 = _getIterator(config_node.nodes);
								...
								case 14:
									...
									for (_iterator4 = _getIterator(key.nodes); !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
										meta_child = _step4.value;
