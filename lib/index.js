(function (global, factory) {
	...
	var require$$0$9 = ( runtime$1 && runtime ) || runtime$1;
	...
	var require$$0$10 = ( runtimeModule$1 && runtimeModule ) || runtimeModule$1;

	var regenerator = require$$0$10;
	...
	var require$$0$12 = ( _iterDetect$1 && _iterDetect ) || _iterDetect$1;
	...
	$export$1($export$1.S + $export$1.F * !(USE_NATIVE && require$$0$12(function (iter) {
	...
	var require$$0$13 = ( promise$1 && promise ) || promise$1;
	...
	var require$$0$15 = ( getPrototypeOf$2 && getPrototypeOf$1 ) || getPrototypeOf$2;
	...
	var require$$0$16 = ( _objectAssign$1 && _objectAssign ) || _objectAssign$1;

	// 19.1.3.1 Object.assign(target, source)


	$export$1($export$1.S + $export$1.F, 'Object', { assign: require$$0$16 });
	...
	var require$$0$17 = ( assign$1 && assign ) || assign$1;
	...
	var require$$0$18 = ( defineProperty$1 && defineProperty ) || defineProperty$1;
	...
	$export$1($export$1.G + $export$1.B, {
	  setImmediate: require$$0$11.set,
	  clearImmediate: require$$0$11.clear
	});
	...
	var require$$0$27 = ( setImmediate$1 && setImmediate ) || setImmediate$1;
	...
	var require$$0$28 = ( getOwnPropertyDescriptor$1 && getOwnPropertyDescriptor ) || getOwnPropertyDescriptor$1;
	...
	var require$$0$29 = ( getOwnPropertyNames$1 && getOwnPropertyNames ) || getOwnPropertyNames$1;
	...
	var require$$0$30 = ( stringify$1 && stringify ) || stringify$1;
	...
	var require$$0$31 = ( isIterable$1 && isIterable ) || isIterable$1;
	...
	$export$1($export$1.S + $export$1.F * !require$$0$12(function (iter) { }), 'Array', {
	...
	var require$$0$32 = ( from$1 && from ) || from$1;
	...
	var require$$0$33 = ( _objectToArray$1 && _objectToArray ) || _objectToArray$1;

	// https://github.com/tc39/proposal-object-values-entries

	var $entries = require$$0$33(true);
	...
	var require$$0$34 = ( entries$1 && entries ) || entries$1;
	...
	var require$$0$35 = ( keys$1 && keys ) || keys$1;
	...
	*/
	 ...
	 */
	  ...
	  */
			...
			key: 'hasBrotherID',
			value: function () {
				var _ref14 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee14() {
					...
					return regenerator.wrap(function _callee14$(_context14) {
						while (1) {
							switch (_context14.prev = _context14.next) {
								...
								case 13:
									node = _context14.sent;
									_context14.next = 16;
									return findValidCommand(node);

								case 16:
									command = _context14.sent;
					...
					}, _callee14, this, [[7, 25, 29, 37], [30,, 32, 36]]);
				}));
						...
						while (1) {
							switch (_context15.prev = _context15.next) {
								...
								case 2:
									...
									return _context15.abrupt('return', brother_ids.includes(id));
					...
					return regenerator.wrap(function _callee17$(_context17) {
						while (1) {
							switch (_context17.prev = _context17.next) {
								...
								case 2:
									parent_node = _context17.sent;
									_context17.next = 5;
									return this.findValidCommand(parent_node);

								case 5:
									parent_command = _context17.sent;
	  ...
	  */
			...
			value: function () {
				var _ref18 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee18() {
					...
					}, _callee18, this, [[7, 24, 28, 36], [29,, 31, 35]]);
				}));
	  ...
	  */
			...
			value: function () {
				var _ref19 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee19() {
						...
						while (1) {
							switch (_context19.prev = _context19.next) {
								...
								case 23:
									...
									_iteratorError12 = _context19.t0;
								...
								case 37:
									return _context19.abrupt('return', resp.join(','));
					...
					}, _callee19, this, [[7, 23, 27, 35], [28,, 30, 34]]);
				}));
					...
					return regenerator.wrap(function _callee21$(_context21) {
						while (1) {
							switch (_context21.prev = _context21.next) {
								...
								case 2:
									parents = _context21.sent;
									return _context21.abrupt('return', parents.map(function (x) {
										id: x.id;
									}));
		...
		var _ref = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee5(context) {
	      ...
	      */
							...
							return _context5.abrupt('return', {
								...
								'def_config': _extends$1({}, null_template, { x_icons: 'desktop_new', x_level: '2' }),
								'def_modelos': _extends$1({}, null_template, { x_icons: 'desktop_new', x_level: '2' }),
								'def_assets': _extends$1({}, null_template, { x_icons: 'desktop_new', x_level: '2' }),
	  ...
	  */
			...
			value: function () {
				var _ref10 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee10() {
					var resp, config_node, search, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, key, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, meta_child;
						...
						while (1) {
							switch (_context10.prev = _context10.next) {
								case 0:
									...
									search = this.dsl_parser.getNodes({ text: 'config', level: 2, icon: 'desktop_new', recurse: true });
									//
									...
									_iteratorError = undefined;
									_context10.prev = 9;
									_iterator = _getIterator(config_node.nodes);
								...
								case 11:
									...
									for (_iterator2 = _getIterator(key.nodes); !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
										meta_child = _step2.value;
										...
										} else if (meta_child.text.toLowerCase() == 'language') {} else if (meta_child.text.toLowerCase() == 'charset') {} else {}
										//
									}
									_context10.next = 25;
									break;
					...
					}, _callee10, this, [[9, 40, 44, 52], [17, 21, 25, 33], [26,, 28, 32], [45,, 47, 51]]);
				}));
