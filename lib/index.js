        ...
        for (var key in _this3.x_commands) {
          ...
          if (command_requires['x_all_hasparent'] != '' && allTrue(matched, keys)) {
            ...
            for (var _key4 of command_requires['x_all_hasparent'].split(',')) {
              matched.x_all_hasparent = yield _this3.hasParentID(node.id, _key4);
          ...
          if (command_requires['x_or_isparent'] != '' && allTrue(matched, keys)) {
            ...
            for (var _key5 of command_requires['x_or_isparent'].split(',')) {
              is_direct = yield _this3.isExactParentID(node.id, _key5);
    ...
    */
      ...
      return _asyncToGenerator(function* () {
        ...
        if (!resp.error) {
          ...
          _this5.x_console.title({
            title: "Interpreter ".concat(_this5.x_config.class, " ENDED. Full Compilation took: ").concat(_this5.secsPassed_(), " secs"),
            color: 'green'
          });
        ...
        _this5.debug('after nodes processing, resp says:', resp); //this.debug('app state says:',this.x_state);
      ...
      return _asyncToGenerator(function* () {
        ...
        if (resp.hasChildren == true) {
          ...
          for (var sublevel of sub_nodes) {
            ...
            var real2 = yield _this6.findValidCommand(real, false, new_state);
    ...
    process_main(node, custom_state) {
      ...
      return _asyncToGenerator(function* () {
        ...
        try {
          var test = yield _this7.findValidCommand(node, false, custom_state); //this.debug(`test para node: text:${node.text}`,test);
          ...
          yield _this7.onErrors(["Error executing func for x_command for node id ".concat(node.id, ", text: ").concat(node.text, " ")]);
          resp.valid = false, resp.hasChildren = false, resp.error = true;
        } // return
    ...
    */
    ...
    isExactParentID() {
      ...
      return _asyncToGenerator(function* () {
        ...
        var parent_command = yield _this12.findValidCommand(parent_node);
    ...
    hasParentID() {
      ...
      return _asyncToGenerator(function* () {
        ...
        for (var parent_id of parents) {
          ...
          var command = yield _this13.findValidCommand(node);
    ...
    getParentIDs() {
      ...
      return _asyncToGenerator(function* () {
        ...
        for (var parent_id of parents) {
          ...
          var command = yield _this14.findValidCommand(node);
