  ...
  class concepto {
    ...
    */
    ...
    findCommand() {
      ...
      return _asyncToGenerator(function* () {
        ...
        var command_requires = node_features = command_defaults = setObjectKeys(keys, '');
        var def_matched = matched = setObjectKeys(keys, true);
        ...
        for (var key in _this3.x_commands) {
          ...
          matched = def_matched; // build template for used keys
          ...
          if (matched.x_icons && command_requires['x_not_icons'] != '') {
            ...
            if (node.icons.length > 0 && command_requires['x_not_icons'] != '' && ['*'].includes(command_requires['x_not_icons'])) {
              ...
              matched.x_not_icons = _this3.array_intersect(command_requires['x_not_icons'].split(','), node.icons).length > 1 ? false : true;
            }
          }
          ...
          if (command_requires['x_or_hasparent'] != '' && allTrue(matched, keys)) {
            ...
            var _test = yield _this3.hasParentID(node.x_id, command_requires['x_or_hasparent']);
          ...
          if (command_requires['x_all_hasparent'] != '' && allTrue(matched, keys)) {
            ...
            for (var _key4 of command_requires['x_all_hasparent'].split(',')) {
              var _test2 = yield _this3.hasParentID(node.x_id, _key4);
          ...
          if (command_requires['x_or_isparent'] != '' && allTrue(matched, keys)) {
            ...
            for (var _key5 of command_requires['x_or_isparent'].split(',')) {
              var _test3 = yield _this3.isExactParentID(node.x_id, _key5);
    ...
    */
    ...
    findValidCommand() {
      ...
      return _asyncToGenerator(function* () {
        ...
        _this4.debug({
          message: 'findValidCommand called for node ' + node.id,
          color: 'yellow'
        });
        ...
        if (commands_.length == 0) {
          ...
          try {
            var test = yield _this4.x_commands[reply.x_id].func(node);
          ...
          for (var qm_index in commands_) {
            ...
            try {
              var _test4 = yield _this4.x_commands[qm.x_id].func(node);
    ...
    */
    ...
    _appFolders(keys, output_dir) {
      ...
      return _asyncToGenerator(function* () {
        ...
        var resp = {
          base: dsl_folder,
          src: dsl_folder + path.sep + _this5.x_state.central_config.apptitle + path.sep
        };
    ...
    */
    ...
    hasBrotherID() {
      ...
      return _asyncToGenerator(function* () {
        var id = _arguments3.length > 0 && _arguments3[0] !== undefined ? _arguments3[0] : _this6.throwIfMissing('id');
        var x_id = _arguments3.length > 1 && _arguments3[1] !== undefined ? _arguments3[1] : _this6.throwIfMissing('x_id');
        // @TODO test it after having 'real' commands on some parser 3-ago-20
        var brother_ids = yield _this6.dsl_parser.getBrotherNodesIDs({
          id,
          before: true,
          after: true
        }).split(',');
        ...
        for (var q of brother_ids) {
          var node = yield _this6.dsl_parser.getNode({
            id: q,
            recurse: false
          });
    ...
    */
    ...
    hasBrotherBefore() {
      ...
      return _asyncToGenerator(function* () {
        var id = _arguments4.length > 0 && _arguments4[0] !== undefined ? _arguments4[0] : _this7.throwIfMissing('id');
    ...
    */
    ...
    hasBrotherNext() {
      ...
      return _asyncToGenerator(function* () {
        var id = _arguments5.length > 0 && _arguments5[0] !== undefined ? _arguments5[0] : _this8.throwIfMissing('id');
    ...
    */
    ...
    isExactParentID() {
      ...
      return _asyncToGenerator(function* () {
        var id = _arguments6.length > 0 && _arguments6[0] !== undefined ? _arguments6[0] : _this9.throwIfMissing('id');
        var x_id = _arguments6.length > 1 && _arguments6[1] !== undefined ? _arguments6[1] : _this9.throwIfMissing('x_id');
        // @TODO test it after having 'real' commands on some parser 4-ago-20
        var parent_node = yield _this9.dsl_parser.getParentNode({
          id
        });
        var parent_command = yield _this9.findValidCommand(parent_node);
    ...
    */
    ...
    hasParentID() {
      ...
      return _asyncToGenerator(function* () {
        var id = _arguments7.length > 0 && _arguments7[0] !== undefined ? _arguments7[0] : _this10.throwIfMissing('id');
        var x_id = _arguments7.length > 1 && _arguments7[1] !== undefined ? _arguments7[1] : _this10.throwIfMissing('x_id');
        // @TODO test it after having 'real' commands on some parser 4-ago-20
    ...
    */
    ...
    getParentIDs() {
      ...
      return _asyncToGenerator(function* () {
        var id = _arguments8.length > 0 && _arguments8[0] !== undefined ? _arguments8[0] : _this11.throwIfMissing('id');
    ...
    */
    ...
    getParentIDs2Array() {
      ...
      return _asyncToGenerator(function* () {
        var id = _arguments9.length > 0 && _arguments9[0] !== undefined ? _arguments9[0] : _this12.throwIfMissing('id');
        return yield _this12.getParentIDs(id, true);
      })();
    ...
    */
    ...
    getParentIDs2ArrayWXID() {
      ...
      return _asyncToGenerator(function* () {
        var id = _arguments10.length > 0 && _arguments10[0] !== undefined ? _arguments10[0] : _this13.throwIfMissing('id');
        // this is only used in ti.cfc: def_textonly (just for back-compatibility in case needed);
        // @deprecated 4-ago-2020
        var parents = yield _this13.getParentIDs(id, true);
