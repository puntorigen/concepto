          ...
          if (_this.x_config.diff_from) {
            yield* function* () {
              ...
              files.from_parser.$("node").each(function (i, elem) {
                ...
                me.$(elem).removeAttr("FOLDED"); //if (i>1 && me.$(elem).attr('FOLDED')) me.$(elem).attr("FOLDED","true");
              });
              ...
              var _loop = function* _loop(key) {
                diff.content = yield diff.parser.editNode({
                  ...
                  data: function data(x) {
                    return {
                      text_note_html: {
                        p: ['ADDED NODE', ...compare.added[key], x.text_note]
                      },
                      cloud: {
                        used: true,
                        bgcolor: '#d9f7be'
              ...
              if (Object.keys(compare.deleted).length > 0) {
                ...
                var from = {};
                from.parser = files.from_parser; //process
