(function (global, factory) {
	...
	require$$0$4(IteratorPrototype, require$$1$2('iterator'), function () { return this; });
	...
	var require$$0$14 = ( getPrototypeOf$2 && getPrototypeOf$1 ) || getPrototypeOf$2;
	...
	var require$$0$15 = ( _objectAssign$1 && _objectAssign ) || _objectAssign$1;

	// 19.1.3.1 Object.assign(target, source)


	$export$1($export$1.S + $export$1.F, 'Object', { assign: require$$0$15 });
	...
	var require$$0$16 = ( assign$1 && assign ) || assign$1;
	...
	var require$$0$17 = ( defineProperty$1 && defineProperty ) || defineProperty$1;
	...
	for (var wellKnownSymbols = getKeys(require$$1$2.store), k = 0; wellKnownSymbols.length > k;) require$$0$21(wellKnownSymbols[k++]);
	...
	$export$1($export$1.G + $export$1.B, {
	  setImmediate: require$$0$10.set,
	  clearImmediate: require$$0$10.clear
	});
	...
	var require$$0$26 = ( setImmediate$1 && setImmediate ) || setImmediate$1;
	...
	var require$$0$27 = ( getOwnPropertyDescriptor$1 && getOwnPropertyDescriptor ) || getOwnPropertyDescriptor$1;
	...
	var require$$0$28 = ( getOwnPropertyNames$1 && getOwnPropertyNames ) || getOwnPropertyNames$1;
	...
	var require$$2$2 = ( core_isIterable$1 && core_isIterable ) || core_isIterable$1;

	var isIterable = require$$2$2;
	...
	var require$$0$29 = ( isIterable$1 && isIterable ) || isIterable$1;
	...
	var require$$0$30 = ( getIterator$1 && getIterator ) || getIterator$1;
	...
	var require$$0$31 = ( from$1 && from ) || from$1;
	...
	var require$$0$32 = ( _objectToArray$1 && _objectToArray ) || _objectToArray$1;

	// https://github.com/tc39/proposal-object-values-entries

	var $entries = require$$0$32(true);
	...
	var require$$0$33 = ( entries$1 && entries ) || entries$1;
	...
	var require$$0$34 = ( keys$1 && keys ) || keys$1;
	...
	**/
	var concepto = function () {
	  ...
	  console.log('x_on_methods says',this.x_on_methods);*/
		...
		_createClass(concepto, [{
						...
						while (1) {
							switch (_context.prev = _context.next) {
								...
								case 13:
									...
									_context.next = 16;
									return this.dsl_parser.getNodes({ level: 2, recurse: false, nodes_raw: true });

								case 16:
									this.x_dsl_nodes = _context.sent;
			...
			key: 'onAfterWritter',
			value: function () {
				var _ref4 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3(processedNodes) {
				...
				function onAfterWritter(_x3) {
					return _ref4.apply(this, arguments);
				}

				return onAfterWritter;
			}()
			...
			value: function () {
				var _ref6 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee5(node) {
			...
			value: function () {
				var _ref7 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee6(node) {
			...
			value: function () {
				var _ref8 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee7(processedNodes) {
			...
			key: 'onErrors',
			value: function () {
				var _ref10 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee9(errors) {
			...
			key: 'onCreateFiles',
			value: function () {
				var _ref11 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee10(processedNodes) {
			...
			key: 'addCommands',
			value: function () {
				var _ref12 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee11(command_func) {
					var t;
			...
			value: function () {
				var _ref13 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee12() {
					...
					var resp, xtest, keys, command_requires, def_matched, comm, key, comm_keys, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, qi, com_reqs, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, test, testpath, _iteratorNormalCompletion4, _didIteratorError4, _iteratorError4, _iterator4, _step4, word, _iteratorNormalCompletion5, _didIteratorError5, _iteratorError5, _iterator5, _step5, _key, _testpath, _iteratorNormalCompletion6, _didIteratorError6, _iteratorError6, _iterator6, _step6, _key2, _iteratorNormalCompletion7, _didIteratorError7, _iteratorError7, _iterator7, _step7, _key3, _iteratorNormalCompletion8, _didIteratorError8, _iteratorError8, _iterator8, _step8, _key4, _iteratorNormalCompletion9, _didIteratorError9, _iteratorError9, _iterator9, _step9, _key5, count, sorted, sorted_ids;

					return regenerator.wrap(function _callee12$(_context12) {
						while (1) {
							switch (_context12.prev = _context12.next) {
								case 0:
									resp = { name: 'not_found', hint: 'failover command' }, xtest = [];
								...
								case 226:
									...
									if (this.hasParentID(node.x_id, _key4)) {
										_context12.next = 231;
										break;
									}

									matched.x_all_hasparent = false;
									return _context12.abrupt('break', 234);
								...
								case 236:
									_context12.prev = 236;
									_context12.t8 = _context12['catch'](224);
								...
								case 246:
									return _context12.finish(243);

								case 247:
									return _context12.finish(240);
								...
								case 257:
									...
									if (this.isExactParentID(node.x_id, _key5)) {
										_context12.next = 262;
										break;
									}

									matched.x_or_isparent = true;
									return _context12.abrupt('break', 265);
								...
								case 267:
									_context12.prev = 267;
									_context12.t9 = _context12['catch'](255);
								...
								case 277:
									return _context12.finish(274);

								case 278:
									return _context12.finish(271);
								...
								case 287:
									return _context12.abrupt('break', 290);
								...
								case 290:
									...
									if (!justone) {
										...
										sorted_ids = sorted.map(function (elem, value) {
											return elem.id;
										});
					...
					}, _callee12, this, [[17, 29, 33, 41], [34,, 36, 40], [51, 68, 72, 80], [73,, 75, 79], [86, 98, 102, 110], [103,, 105, 109], [116, 139, 143, 151], [144,, 146, 150], [159, 171, 175, 183], [176,, 178, 182], [188, 200, 204, 212], [205,, 207, 211], [224, 236, 240, 248], [241,, 243, 247], [255, 267, 271, 279], [272,, 274, 278]]);
				}));
			...
			value: function hasBrotherBefore() {
				var id = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.throwIfMissing('id');

				var brother_ids = this.dsl_parser.getBrotherNodesIDs({ id: id, before: true, after: false }).split(',');
			...
			key: 'hasBrotherNext',
			value: function hasBrotherNext() {
				var id = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.throwIfMissing('id');

				var brother_ids = this.dsl_parser.getBrotherNodesIDs({ id: id, before: false, after: true }).split(',');
				return brother_ids.includes(id);
			}
			...
			key: 'isExactParentID',
			value: function isExactParentID() {
				var id = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.throwIfMissing('id');
				var x_id = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.throwIfMissing('x_id');
			...
			value: function getParentIDs2Array() {
				var id = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.throwIfMissing('id');
			...
			value: function getParentIDs2ArrayWXID() {
				var id = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.throwIfMissing('id');
			...
			value: function struct2params() {
				...
				try {
					for (var _iterator10 = _getIterator(_Object$entries(struct)), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
						var _ref14 = _step10.value;
	...
	function allTrue(object, keys) {
		...
		try {
			for (var _iterator11 = _getIterator(keys.split(',')), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
	...
	function numberInCondition(num, test) {
		...
		if (test.indexOf('>') != -1 || test.indexOf('<') != -1) {
			...
			try {
				for (var _iterator12 = _getIterator(test.split(',')), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
					var i = _step12.value;
			...
			try {
				for (var _iterator13 = _getIterator(test.split(',')), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
	...
	var internal_commands = (function () {
		var _ref = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(context) {
			var me;
			return regenerator.wrap(function _callee2$(_context2) {
				while (1) {
					switch (_context2.prev = _context2.next) {
										...
										var _ref2 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(node) {
											...
											return regenerator.wrap(function _callee$(_context) {
												while (1) {
													switch (_context.prev = _context.next) {
														case 0:
															resp = me.reply_template({ otro: 'Pablo' });
	...
	var vue = function (_concepto) {
		...
		function vue(_ref) {
			...
			return _possibleConstructorReturn(this, (vue.__proto__ || _Object$getPrototypeOf(vue)).call(this, { file: file, config: nuevo_config })); //,...my_config
		}
				...
				var me = this,
					...
					'def_mapa': {
						...
						func: function func(node) {
							var resp = me.reply_template({ otro: 'Pablo' });
	  ...
	  */
			...
			key: 'onlyOnVue',
			value: function onlyOnVue(x_id, x_text) {
				console.log('i am only on vue class');
			}
		}, {
			key: 'onlyOnVue2',
			value: function onlyOnVue2() {
				var _ref3 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
				    _ref3$x_id = _ref3.x_id,
				    x_id = _ref3$x_id === undefined ? 'def_mapa' : _ref3$x_id,
				    _ref3$x_text = _ref3.x_text;
