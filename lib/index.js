(function (global, factory) {
	...
	**/
		...
		_createClass(concepto, [{
			...
			value: function () {
				var _ref2 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
					var dsl_parser, path, tmp, for_git;
						...
						while (1) {
							switch (_context.prev = _context.next) {
								case 0:
									...
									dsl_parser = require('dsl_parser'), path = require('path'), tmp = {};
									// show title
								...
								case 13:
									...
									_context.next = 16;
									return this.dsl_parser.getNodes({ level: 2, recurse: true });
			...
			key: 'addCommands',
			value: function addCommands(command_func) {
				if (command_func && typeof command_func === 'function') {
					var t = command_func(this);
				...
				} else if (command_func && (typeof command_func === 'undefined' ? 'undefined' : _typeof(command_func)) === 'object') {
			...
			key: 'getInstanceMethodNames',
			value: function getInstanceMethodNames(obj, stop) {
				var array = [];
				var proto = _Object$getPrototypeOf(obj);
				var me = this;
				while (proto && proto !== stop) {
					console.log('processing proto:', proto);
					_Object$getOwnPropertyNames(proto).forEach(function (name, pos) {
						if (name !== 'constructor') {
			...
			key: 'hasMethod',
			value: function hasMethod(obj, name) {
				var desc = _Object$getOwnPropertyDescriptor(obj, name);
	...
	function extra_commands(context) {
		var me = context;
		return {
			'def_otro': {
				x_icons: 'cancel',
						...
						while (1) {
							switch (_context.prev = _context.next) {
								case 0:
									...
									this.addCommands(extra_commands);
