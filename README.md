...
* [concepto](#module_concepto)
    * _instance_
        ...
        * [.addAutocompleteDefinition([extends_], [parents], [text], [icons], [level], [hint], [attributes])](#module_concepto+addAutocompleteDefinition) ⇒ <code>Object</code>
...
### concepto.addAutocompleteDefinition([extends_], [parents], [text], [icons], [level], [hint], [attributes]) ⇒ <code>Object</code>
